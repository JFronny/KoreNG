...
public class DownNodeTypeAdapter implements TypeAdapter<DownNode> {
    @Override
    public DownNode deserialize(Element node, XmlParser parser) throws XmlException {
        ...
        return new DownNode(aiNodes);
    }

    @Override
    public void serializeTo(Element node, DownNode value, XmlParser parser, NodeBuilder builder) throws XmlException {
